...
{
    public static class GetZPAServiceEdgeController
    {
        public static Task<GetZPAServiceEdgeControllerResult> InvokeAsync(GetZPAServiceEdgeControllerArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetZPAServiceEdgeControllerResult>("zpa:index/getZPAServiceEdgeController:getZPAServiceEdgeController", args ?? new GetZPAServiceEdgeControllerArgs(), options.WithDefaults());

        public static Output<GetZPAServiceEdgeControllerResult> Invoke(GetZPAServiceEdgeControllerInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetZPAServiceEdgeControllerResult>("zpa:index/getZPAServiceEdgeController:getZPAServiceEdgeController", args ?? new GetZPAServiceEdgeControllerInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetZPAServiceEdgeControllerArgs : Pulumi.InvokeArgs
    {
        [Input("name")]
        public string? Name { get; set; }

        public GetZPAServiceEdgeControllerArgs()
        {
        }
    }

    public sealed class GetZPAServiceEdgeControllerInvokeArgs : Pulumi.InvokeArgs
    {
        [Input("name")]
        public Input<string>? Name { get; set; }

        public GetZPAServiceEdgeControllerInvokeArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetZPAServiceEdgeControllerResult
    {
        ...
        [OutputConstructor]
        private GetZPAServiceEdgeControllerResult(
