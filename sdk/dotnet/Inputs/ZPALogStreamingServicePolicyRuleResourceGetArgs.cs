...
namespace Pulumi.willguibr.Inputs
{
    ...
    public sealed class ZPALogStreamingServicePolicyRuleResourceGetArgs : Pulumi.ResourceArgs
    {
        [Input("action")]
        ...
        [Input("conditions")]
        private InputList<Inputs.ZPALogStreamingServicePolicyRuleResourceConditionGetArgs>? _conditions;
        public InputList<Inputs.ZPALogStreamingServicePolicyRuleResourceConditionGetArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Inputs.ZPALogStreamingServicePolicyRuleResourceConditionGetArgs>());
        ...
        public ZPALogStreamingServicePolicyRuleResourceGetArgs()
        {
        }
    }
}
