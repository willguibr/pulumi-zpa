...
namespace Pulumi.willguibr
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/willguibr/pulumi-zpa/releases/download/v${VERSION}";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.willguibr.version.txt");
    ...
    internal sealed class willguibrResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public willguibrResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
