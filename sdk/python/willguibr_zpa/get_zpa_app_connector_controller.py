...
__all__ = [
    'GetZPAAppConnectorControllerResult',
    'AwaitableGetZPAAppConnectorControllerResult',
    'get_zpa_app_connector_controller',
    'get_zpa_app_connector_controller_output',
]

@pulumi.output_type
class GetZPAAppConnectorControllerResult:
    """
    A collection of values returned by getZPAAppConnectorController.
    """
    def __init__(__self__, app_connector_group_id=None, app_connector_group_name=None, application_start_time=None, control_channel_status=None, creation_time=None, ctrl_broker_name=None, current_version=None, description=None, enabled=None, enrollment_cert=None, expected_upgrade_time=None, expected_version=None, fingerprint=None, id=None, ip_acl=None, issued_cert_id=None, last_broker_connect_time=None, last_broker_connect_time_duration=None, last_broker_disconnect_time=None, last_broker_disconnect_time_duration=None, last_upgrade_time=None, latitude=None, location=None, longitude=None, modified_time=None, modifiedby=None, name=None, platform=None, previous_version=None, private_ip=None, provisioning_key_id=None, provisioning_key_name=None, public_ip=None, sarge_version=None, upgrade_attempt=None, upgrade_status=None):
...
class AwaitableGetZPAAppConnectorControllerResult(GetZPAAppConnectorControllerResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetZPAAppConnectorControllerResult(
...
def get_zpa_app_connector_controller(name: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetZPAAppConnectorControllerResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('zpa:index/getZPAAppConnectorController:getZPAAppConnectorController', __args__, opts=opts, typ=GetZPAAppConnectorControllerResult).value

    return AwaitableGetZPAAppConnectorControllerResult(
...
@_utilities.lift_output_func(get_zpa_app_connector_controller)
def get_zpa_app_connector_controller_output(name: Optional[pulumi.Input[Optional[str]]] = None,
                                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetZPAAppConnectorControllerResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
