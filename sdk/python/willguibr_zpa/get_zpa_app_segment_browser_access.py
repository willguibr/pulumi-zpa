...
__all__ = [
    'GetZPAAppSegmentBrowserAccessResult',
    'AwaitableGetZPAAppSegmentBrowserAccessResult',
    'get_zpa_app_segment_browser_access',
    'get_zpa_app_segment_browser_access_output',
]

@pulumi.output_type
class GetZPAAppSegmentBrowserAccessResult:
    """
    ...
    def clientless_apps(self) -> Sequence['outputs.GetZPAAppSegmentBrowserAccessClientlessAppResult']:
    ...
    def server_groups(self) -> Sequence['outputs.GetZPAAppSegmentBrowserAccessServerGroupResult']:
...
class AwaitableGetZPAAppSegmentBrowserAccessResult(GetZPAAppSegmentBrowserAccessResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetZPAAppSegmentBrowserAccessResult(
...
def get_zpa_app_segment_browser_access(id: Optional[str] = None,
                                       name: Optional[str] = None,
                                       tcp_port_ranges: Optional[Sequence[pulumi.InputType['GetZPAAppSegmentBrowserAccessTcpPortRangeArgs']]] = None,
                                       udp_port_ranges: Optional[Sequence[pulumi.InputType['GetZPAAppSegmentBrowserAccessUdpPortRangeArgs']]] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetZPAAppSegmentBrowserAccessResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('zpa:index/getZPAAppSegmentBrowserAccess:getZPAAppSegmentBrowserAccess', __args__, opts=opts, typ=GetZPAAppSegmentBrowserAccessResult).value

    return AwaitableGetZPAAppSegmentBrowserAccessResult(
...
@_utilities.lift_output_func(get_zpa_app_segment_browser_access)
def get_zpa_app_segment_browser_access_output(id: Optional[pulumi.Input[Optional[str]]] = None,
                                              name: Optional[pulumi.Input[Optional[str]]] = None,
                                              tcp_port_ranges: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetZPAAppSegmentBrowserAccessTcpPortRangeArgs']]]]] = None,
                                              udp_port_ranges: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetZPAAppSegmentBrowserAccessUdpPortRangeArgs']]]]] = None,
                                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetZPAAppSegmentBrowserAccessResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
