...
__all__ = [
    'GetZPASCIMGroupsResult',
    'AwaitableGetZPASCIMGroupsResult',
    'get_zpascim_groups',
    'get_zpascim_groups_output',
]

@pulumi.output_type
class GetZPASCIMGroupsResult:
    """
...
class AwaitableGetZPASCIMGroupsResult(GetZPASCIMGroupsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetZPASCIMGroupsResult(
...
def get_zpascim_groups(id: Optional[str] = None,
                       idp_id: Optional[int] = None,
                       idp_name: Optional[str] = None,
                       name: Optional[str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetZPASCIMGroupsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('zpa:index/getZPASCIMGroups:getZPASCIMGroups', __args__, opts=opts, typ=GetZPASCIMGroupsResult).value

    return AwaitableGetZPASCIMGroupsResult(
        creation_time=__ret__.creation_time,
        id=__ret__.id,
        idp_group_id=__ret__.idp_group_id,
...
@_utilities.lift_output_func(get_zpascim_groups)
def get_zpascim_groups_output(id: Optional[pulumi.Input[Optional[str]]] = None,
                              idp_id: Optional[pulumi.Input[Optional[int]]] = None,
                              idp_name: Optional[pulumi.Input[Optional[str]]] = None,
                              name: Optional[pulumi.Input[Optional[str]]] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetZPASCIMGroupsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
