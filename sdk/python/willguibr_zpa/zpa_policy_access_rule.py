...
__all__ = ['ZPAPolicyAccessRuleArgs', 'ZPAPolicyAccessRule']

@pulumi.input_type
class ZPAPolicyAccessRuleArgs:
    def __init__(__self__, *,
                 action: Optional[pulumi.Input[str]] = None,
                 action_id: Optional[pulumi.Input[str]] = None,
                 app_connector_groups: Optional[pulumi.Input[Sequence[pulumi.Input['ZPAPolicyAccessRuleAppConnectorGroupArgs']]]] = None,
                 app_server_groups: Optional[pulumi.Input[Sequence[pulumi.Input['ZPAPolicyAccessRuleAppServerGroupArgs']]]] = None,
                 bypass_default_rule: Optional[pulumi.Input[bool]] = None,
                 conditions: Optional[pulumi.Input[Sequence[pulumi.Input['ZPAPolicyAccessRuleConditionArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ZPAPolicyAccessRuleConditionArgs']]] conditions: This is for proviidng the set of conditions for the policy.
    ...
    def app_connector_groups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ZPAPolicyAccessRuleAppConnectorGroupArgs']]]]:
        """
    ...
    def app_connector_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ZPAPolicyAccessRuleAppConnectorGroupArgs']]]]):
        pulumi.set(self, "app_connector_groups", value)

    @property
    @pulumi.getter(name="appServerGroups")
    def app_server_groups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ZPAPolicyAccessRuleAppServerGroupArgs']]]]:
        """
    ...
    def app_server_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ZPAPolicyAccessRuleAppServerGroupArgs']]]]):
    ...
    @property
    @pulumi.getter
    def conditions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ZPAPolicyAccessRuleConditionArgs']]]]:
        """
    ...
    @conditions.setter
    def conditions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ZPAPolicyAccessRuleConditionArgs']]]]):
...
@pulumi.input_type
class _ZPAPolicyAccessRuleState:
    def __init__(__self__, *,
                 action: Optional[pulumi.Input[str]] = None,
                 action_id: Optional[pulumi.Input[str]] = None,
                 app_connector_groups: Optional[pulumi.Input[Sequence[pulumi.Input['ZPAPolicyAccessRuleAppConnectorGroupArgs']]]] = None,
...
class ZPAPolicyAccessRule(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 action: Optional[pulumi.Input[str]] = None,
                 action_id: Optional[pulumi.Input[str]] = None,
                 app_connector_groups: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ZPAPolicyAccessRuleAppConnectorGroupArgs']]]]] = None,
                 app_server_groups: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ZPAPolicyAccessRuleAppServerGroupArgs']]]]] = None,
                 bypass_default_rule: Optional[pulumi.Input[bool]] = None,
                 conditions: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ZPAPolicyAccessRuleConditionArgs']]]]] = None,
                 custom_msg: Optional[pulumi.Input[str]] = None,
                 default_rule: Optional[pulumi.Input[bool]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 lss_default_rule: Optional[pulumi.Input[bool]] = None,
                 ...
                 __props__=None):
        """
        Create a ZPAPolicyAccessRule resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ZPAPolicyAccessRuleConditionArgs']]]] conditions: This is for proviidng the set of conditions for the policy.
        :param pulumi.Input[str] custom_msg: This is for providing a customer message for the user.
        :param pulumi.Input[bool] default_rule: This is for providing a customer message for the user.
        :param pulumi.Input[str] description: This is the description of the access policy.
        :param pulumi.Input[str] name: This is the name of the policy.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ZPAPolicyAccessRuleArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a ZPAPolicyAccessRule resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param ZPAPolicyAccessRuleArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ZPAPolicyAccessRuleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ZPAPolicyAccessRuleArgs.__new__(ZPAPolicyAccessRuleArgs)
        ...
        super(ZPAPolicyAccessRule, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            reauth_idle_timeout: Optional[pulumi.Input[str]] = None,
            reauth_timeout: Optional[pulumi.Input[str]] = None,
            rule_order: Optional[pulumi.Input[str]] = None) -> 'ZPAPolicyAccessRule':
        """
        ...
        __props__ = _ZPAPolicyAccessRuleState.__new__(_ZPAPolicyAccessRuleState)
        ...
        __props__.__dict__["reauth_timeout"] = reauth_timeout
        __props__.__dict__["rule_order"] = rule_order
        return ZPAPolicyAccessRule(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="appConnectorGroups")
    def app_connector_groups(self) -> pulumi.Output[Sequence['outputs.ZPAPolicyAccessRuleAppConnectorGroup']]:
        """
        List of app-connector IDs.
        """
        return pulumi.get(self, "app_connector_groups")
    ...
    @property
    @pulumi.getter(name="appServerGroups")
    def app_server_groups(self) -> pulumi.Output[Sequence['outputs.ZPAPolicyAccessRuleAppServerGroup']]:
        """
        List of the server group IDs.
        """
        return pulumi.get(self, "app_server_groups")
    ...
    @property
    @pulumi.getter
    def conditions(self) -> pulumi.Output[Sequence['outputs.ZPAPolicyAccessRuleCondition']]:
        """
        This is for proviidng the set of conditions for the policy.
        """
        return pulumi.get(self, "conditions")
